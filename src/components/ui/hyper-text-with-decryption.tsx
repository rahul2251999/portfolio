  ...
  return (
    <motion.span
      ...
      animate={{
        ...
        color: isHovered ? "#FFFFFF" : isHighlightable ? "#FFFFFF" : "#cccccc", // White on hover, White if interactive, Gray default
      ...
      <AnimatePresence>
        {isHovered && (
          <motion.span
            ...
            style={{
              boxShadow:
                "0px 10px 25px -5px rgba(255, 255, 255, 0.1), 0px 8px 10px -6px rgba(0, 0, 0, 0.3)",
            }}
          />
        )}
      </AnimatePresence>
        ...
        {isHovered && (
          <>
            <motion.span
              ...
              animate={{ scale: 1 }}
              exit={{ scale: 0 }}
              className="absolute -top-1 -right-1 w-2 h-2 bg-white rounded-full z-20"
            />
            <motion.span
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              exit={{ scale: 0 }}
              className="absolute -bottom-1 -left-1 w-2 h-2 bg-white rounded-full z-20"
            />
          </>
        )}
      </AnimatePresence>
